...
import { Clock, Search, Edit, Trash2, X, Plus, Save, ChevronLeft, ChevronRight } from 'lucide-react';
...
const QuanLyCaTrucPage = () => {
  ...
  const filtered = useMemo(() => {
    ...
    return list.filter(
      (ca) =>
        ca.tenCa?.toLowerCase().includes(searchTerm) ||
        ca.maCa?.toLowerCase().includes(searchTerm)
    );
  }, [list, search]);
